...
public interface PostRepository extends JpaRepository<Posts, Long>, JpaSpecificationExecutor<Posts> {
    ...
    Page<Posts> searchPostsByMultipleKeywords3(String keyword1, String keyword2, String keyword3, Pageable pageable);
    ...
    Page<Posts> searchPostsByMultipleKeywords4(String keyword1, String keyword2, String keyword3, String keyword4, Pageable pageable);
    @Query("SELECT p FROM Posts p WHERE " +
            "LOWER(p.title) LIKE LOWER(CONCAT('%', :keyword1, '%')) OR " +
            "LOWER(p.content) LIKE LOWER(CONCAT('%', :keyword1, '%')) OR " +
            "LOWER(p.hashtag) LIKE LOWER(CONCAT('%', :keyword1, '%')) OR " +
    ...
    Page<Posts> searchPostsByMultipleKeywords5(String keyword1, String keyword2, String keyword3, String keyword4, String keyword5, Pageable pageable);
    ...
    Page<Posts> searchPostsByMultipleKeywords6(String keyword1, String keyword2, String keyword3, String keyword4, String keyword5, String keyword6, Pageable pageable);
    @Query("SELECT p FROM Posts p WHERE " +
            "LOWER(p.title) LIKE LOWER(CONCAT('%', :keyword1, '%')) OR " +
            "LOWER(p.content) LIKE LOWER(CONCAT('%', :keyword1, '%')) OR " +
            "LOWER(p.hashtag) LIKE LOWER(CONCAT('%', :keyword1, '%')) OR " +
    ...
    Page<Posts> searchPostsByMultipleKeywords7(String keyword1, String keyword2, String keyword3, String keyword4, String keyword5, String keyword6, String keyword7, Pageable pageable);
